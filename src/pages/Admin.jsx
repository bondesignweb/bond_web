            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/25 text-xs mt-1">{project.category} &middot; {(project.image_count || project.images || 0)} images &middot; {project.date}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 bg-white/5 rounded-full flex items-center justify-center text-white/20 shrink-0 overflow-hidden">
                {(member.image || member.image_path) ? (
                  <img src={member.image || member.image_path} alt={member.name} className="w-full h-full object-cover" />
                ) : (
...
const navItems = [
  ...
  { key: 'journal', label: 'Journal', icon: Icons.Press },
...
export default function Admin() {
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case 'portfolios': return <PortfolioManager />;
      case 'team': return <TeamManager />;
      case 'journal': return <JournalManager />;
