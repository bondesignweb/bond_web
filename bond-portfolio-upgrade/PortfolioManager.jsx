...
function PortfolioManager() {
  ...
  const [form, setForm] = useState({
    title: '', category: 'New Construction', location: 'Park City',
  ...
  const openAdd = () => {
    setEditProject(null);
    setForm({ title: '', category: 'New Construction', location: 'Park City', description: '', year: new Date().getFullYear().toString(), status: 'Draft', featured: false, cover_image: '' });
    setModalOpen(true);
  };
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select value={form.category} onChange={e => setForm({...form, category: e.target.value})}
                      ...
                      <option>Interior Furnishings</option>
                    </select>
                  </div>
                  <div>
                ...
                {/* Cover image URL */}
                <div>
                  <label className="block text-[10px] tracking-[0.15em] text-white/40 uppercase mb-2">Cover Image URL</label>
