...
export default function ContactPage() {
  ...
  return (
    <PageTransition>
      <section className="pt-36 pb-8 md:pt-48 md:pb-12 px-6 md:px-12 lg:px-20 bg-[var(--color-bg-primary)]">
        <div className="max-w-[900px] mx-auto text-center">
          <ScrollReveal>
            <span className="block text-[10px] tracking-[0.4em] uppercase text-[var(--color-text-accent)] font-light mb-4" style={{ fontFamily: "var(--font-body)" }}>
              Get In Touch
            </span>
      ...
      <section className="w-full">
        <div className="grid lg:grid-cols-2">
          ...
          <div className="flex items-center bg-[var(--color-bg-primary)]">
            <div className="px-10 py-20 md:px-16 lg:px-20 w-full">
              <ScrollReveal>
                ...
                <p className="text-[var(--color-text-light)] text-sm font-light leading-[1.8] mb-10" style={{ fontFamily: "var(--font-body)" }}>
                  Tell us about your project and we&apos;ll be in touch within 48 hours.
                </p>

                {submitted ? (
                  <div className="py-16 text-center">
                    <div className="w-16 h-px bg-[var(--color-text-accent)] mx-auto mb-8" />
                    <h3 style={{ fontFamily: "var(--font-display)" }} className="text-3xl font-light text-[var(--color-charcoal)] mb-4">Thank You</h3>
                    <p className="text-[var(--color-text-light)] text-sm font-light" style={{ fontFamily: "var(--font-body)" }}>We&apos;ll be in touch soon.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-7">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-4 mt-1">
                        {SERVICES.map((s) => (
                          <label key={s} className="flex items-center gap-2 text-sm text-[var(--color-text-light)] font-light cursor-pointer" style={{ fontFamily: "var(--font-body)" }}>
                            <input
                              type="checkbox"
                              name="services"
                              value={s}
      ...
      <section className="py-16 px-6 md:px-12 lg:px-20 bg-[var(--color-cream)]">
        <div className="max-w-[600px] mx-auto text-center space-y-4">
          <a href="tel:4352204809" className="block text-[var(--color-charcoal)] hover:text-[var(--color-text-accent)] transition-colors text-sm font-light" style={{ fontFamily: "var(--font-body)" }}>(435) 220-4809</a>
          <a href="mailto:info@bonddesigncompany.com" className="block text-[var(--color-charcoal)] hover:text-[var(--color-text-accent)] transition-colors text-sm font-light" style={{ fontFamily: "var(--font-body)" }}>info@bonddesigncompany.com</a>
          <a href="https://www.instagram.com/bonddesigncompany/" target="_blank" className="inline-block text-[var(--color-text-accent)] text-sm font-light mt-2" style={{ fontFamily: "var(--font-body)" }}>@bonddesigncompany</a>
        </div>
      </section>
    </PageTransition>
  );
